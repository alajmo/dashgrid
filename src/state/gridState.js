...
function GridState(options) {
    let gridState = {
        ...
        resizable: {
            ...
            northHandleThickness: (options.resizable &&  options.resizable.northHandleThickness !== undefined) ? options.resizable.northHandleThickness : 10,
            southHandleThickness: (options.resizable &&  options.resizable.southHandleThickness !== undefined) ? options.resizable.southHandleThickness : 10,
            eastHandleThickness: (options.resizable &&  options.resizable.eastHandleThickness !== undefined) ? options.resizable.eastHandleThickness : 10,
            westHandleThickness: (options.resizable &&  options.resizable.westhHandleThickness !== undefined) ? options.resizable.westthHandleThickness : 10,
